...
// Mesma observação do bridge de OS: WebSocket exige o gevent_port (default container 8072).
// Configure ODOO_GEVENT_URL apontando para ele (ex: ws://localhost:8073).
const GEVENT_URL_ENV = process.env.ODOO_GEVENT_URL
const CHANNEL = 'afr.supervisorio.ciclos'
